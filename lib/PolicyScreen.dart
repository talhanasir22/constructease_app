        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                'This privacy policy applies to the ConstructEase app (hereby referred to as "Application") for mobile devices that was created by Farhan Tech (hereby referred to as "Service Provider") as a Free service. This service is intended for use "AS IS".',
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                  'The Application is not used to knowingly solicit data from or market to children under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children. The Service Provider encourages all children to never submit any personally identifiable information through the Application and/or Services. Parents and legal guardians are encouraged to monitor their children\'s internet usage and help enforce this policy by instructing their children never to provide personally identifiable information through the Application and/or Services without permission. If you have reason to believe that a child has provided personally identifiable information to the Service Provider through the Application and/or Services, please contact the Service Provider (muhammadfarhanshoukat63@gmail.com) so that necessary actions can be taken. You must also be at least 16 years of age to consent to the processing of your personally identifiable information in your country (in some countries, your parent or guardian may be allowed to consent on your behalf).',
               style: TextStyle(color: Colors.black, fontSize: 14),
               ),
            ),
           Padding(
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text('If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at muhammadfarhanshoukat63@gmail.com.',style: TextStyle(color: Colors.black , fontSize: 14),),
            ),
          ],
        ),
      ),
